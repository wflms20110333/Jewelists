...
public class Settings
{
	...
	public Settings()
	{
		...
		player1UI = new UI();
		player1UI.addButton("0", "button_key1", WIDTH / 4 - 64, (int) (HEIGHT * 0.3));
		player1UI.addButton("1", "button_key1", WIDTH / 4 - 64 - 100, (int) (HEIGHT * 0.3) + 100);
		player1UI.addButton("2", "button_key1", WIDTH / 4 - 64, (int) (HEIGHT * 0.3) + 100);
		player1UI.addButton("3", "button_key1", WIDTH / 4 - 64 + 100, (int) (HEIGHT * 0.3) + 100);
		player1UI.addButton("4", "button_key1", WIDTH * 3 / 4 - 64 - 292, (int) (HEIGHT * 0.3) + 100);
		player1UI.addButton("5", "button_key1", WIDTH * 3 / 4 - 64 - 192, (int) (HEIGHT * 0.3) + 100);
		player1UI.addButton("6", "button_key1", WIDTH * 3 / 4 - 64 - 92, (int) (HEIGHT * 0.3) + 100);
		player1UI.addButton("7", "button_key1", WIDTH * 3 / 4 - 64 + 8, (int) (HEIGHT * 0.3) + 100);
		player1UI.addButton("8", "button_key1", WIDTH * 3 / 4 - 64 + 108, (int) (HEIGHT * 0.3) + 100);
		player2UI = new UI();
		player2UI.addButton("0", "button_key2", WIDTH / 4 - 64, (int) (HEIGHT * 0.3));
		player2UI.addButton("1", "button_key2", WIDTH / 4 - 64 - 100, (int) (HEIGHT * 0.3) + 100);
		player2UI.addButton("2", "button_key2", WIDTH / 4 - 64, (int) (HEIGHT * 0.3) + 100);
		player2UI.addButton("3", "button_key2", WIDTH / 4 - 64 + 100, (int) (HEIGHT * 0.3) + 100);
		player2UI.addButton("4", "button_key2", WIDTH * 3 / 4 - 64 - 292, (int) (HEIGHT * 0.3) + 100);
		player2UI.addButton("5", "button_key2", WIDTH * 3 / 4 - 64 - 192, (int) (HEIGHT * 0.3) + 100);
		player2UI.addButton("6", "button_key2", WIDTH * 3 / 4 - 64 - 92, (int) (HEIGHT * 0.3) + 100);
		player2UI.addButton("7", "button_key2", WIDTH * 3 / 4 - 64 + 8, (int) (HEIGHT * 0.3) + 100);
		player2UI.addButton("8", "button_key2", WIDTH * 3 / 4 - 64 + 108, (int) (HEIGHT * 0.3) + 100);
		player1Screen = true;
	}
			...
			else
			{
				...
				for (int i = 0; i < 9; i++) {
					if (player2UI.isButtonClicked("" + i)) {
						Keyboard.next();
						StateManager.setKeys(2, i, Keyboard.getEventKey());
					}
				}
			}
		}
